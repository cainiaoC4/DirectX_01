...
// Intel:
typedef bool    (CALLBACK *LPDXUTCALLBACKCMDLINEARG)( const WCHAR* arg, const WCHAR* param, void* pUserContext );
...
// Intel:
void WINAPI DXUTSetCallbackCommandLineArg( LPDXUTCALLBACKCMDLINEARG pCallback, void* pUserContext = NULL );
